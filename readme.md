...
#### You will prorably not need all the ffmpeg buildpacks and will probably only need [`jonathanong-ffmpeg`](https://github.com/jonathanong/heroku-buildpack-ffmpeg-latest.git) but get all of them just to be safe. You may need to mess around with other settings to fix errors if they occur
