# This branch of the repository is deprecated I recommend using the newest version [re-write branch](https://github.com/CharmingMother/kurusaki_voice/tree/re-write(master))
